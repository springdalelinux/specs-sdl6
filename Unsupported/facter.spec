...
%define has_ruby_abi 0%{?fedora:%fedora} >= 5 || 0%{?rhel:%rhel} >= 4
...
%doc CHANGELOG CONTRIBUTING.md LICENSE README.md documentation


%changelog
* Thu Jun 28 2012 Thomas Uphill <uphill@ias.edu> - 1.6.10
- update to 1.6.10

* Mon Mar 23 2009 Thomas Uphill <uphill@ias.edu> - 1.5.4-1
- new subdirectories, util and plist added to files and install section
