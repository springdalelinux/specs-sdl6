...
%configure $CONFIGURE_FLAGS --enable-x86-debugger --enable-debugger --enable-iodebug
make %{?_smp_mflags}
mv bochs bochs-debugger
make dist-clean

%configure $CONFIGURE_FLAGS --enable-x86-debugger --enable-gdb-stub --enable-iodebug
make %{?_smp_mflags}
mv bochs bochs-gdb
make dist-clean

%configure $CONFIGURE_FLAGS --enable-iodebug
make %{?_smp_mflags}
...
* Tue Feb 20 2012 Jon Ciesla <limburgher@gmail.com> - 2.5.1-2
