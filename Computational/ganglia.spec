...
## Put files in place
cp -p gmetad/gmetad-default $RPM_BUILD_ROOT%{_sysconfdir}/sysconfig/gmetad
...
# first precompile python modules
python -c 'import compileall; compileall.compile_dir("gmond/python_modules", 1, "/", 1)'
...
%config(noreplace) %{_sysconfdir}/sysconfig/gmetad
