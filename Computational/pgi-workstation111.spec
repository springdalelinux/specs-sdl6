...
%define fulldirv %{destdir}/linux86/2011
%endif
%ifarch x86_64
%define fulldir %{destdir}/linux86-64/%{version}
%define fulldirv %{destdir}/linux86-64/2011
%endif
...
prepend-path    LD_LIBRARY_PATH %{fulldir}/lib:%{fulldir}/%{liblf}:%{fulldirv}/cuda/3.2/%{_lib}:%{fulldirv}/cuda/3.1/%{_lib}
set     version      "3.2.3"
ENDDEFAULT
