...
cp imap/mailutil/mailutil $RPM_BUILD_ROOT/%{_bindir}
cp imap/mlock/mlock $RPM_BUILD_ROOT/%{_bindir}
cp imap/mtest/mtest $RPM_BUILD_ROOT/%{_bindir}
cp imap/tmail/tmail $RPM_BUILD_ROOT/%{_bindir}
cp imap/dmail/dmail $RPM_BUILD_ROOT/%{_bindir}
