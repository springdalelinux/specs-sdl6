...
Summary:        Updated Mozilla Firefox Web browser
Name:           firefox-new
Version:        10.0
Release:        1%{?dist}
...
%if %{build_langpacks}
Source2:        firefox-langpacks-%{version}-20110927.tar.bz2
%endif
Source10:       firefox-mozconfig
Source11:       firefox-mozconfig-branded
Source12:       firefox-redhat-default-prefs.js
Source20:       firefox-new.desktop
...
#MOZ_MAKE_FLAGS="$MOZ_SMP_FLAGS" ./configure  --prefix=%{_prefix} --exec-prefix=%{_exec_prefix} --bindir=%{_bindir} --sbindir=%{_sbindir} --sysconfdir=%{_sysconfdir} --datadir=%{_datadir} --includedir=%{_includedir} --libdir=%{_libdir} --libexecdir=%{_libexecdir} --localstatedir=%{_localstatedir} --sharedstatedir=%{_sharedstatedir} --mandir=%{_mandir} --infodir=%{_infodir} --disable-libjpeg-turbo --disable-wrap-malloc --disable-elf-hack --enable-official-branding --enable-install-strip
./configure  --prefix=%{_prefix} --exec-prefix=%{_exec_prefix} --bindir=%{_bindir} --sbindir=%{_sbindir} --sysconfdir=%{_sysconfdir} --datadir=%{_datadir} --includedir=%{_includedir} --libdir=%{_libdir} --libexecdir=%{_libexecdir} --localstatedir=%{_localstatedir} --sharedstatedir=%{_sharedstatedir} --mandir=%{_mandir} --infodir=%{_infodir} --disable-libjpeg-turbo --disable-wrap-malloc --disable-elf-hack --enable-official-branding --enable-install-strip --with-app-name=%{name}
...
Version=1.0
Encoding=UTF-8
Name=Firefox Web Browser %{version}
Name[ca]=Navegador web Firefox %{version}
Name[cs]=Firefox Webový prohlížeč %{version}
Name[es]=Navegador web Firefox %{version}
Name[fa]=ﻡﺭﻭﺭگﺭ ﺍیﻦﺗﺮﻨﺗی Firefox %{version}
Name[fi]=Firefox-selain %{version}
Name[fr]=Navigateur Web Firefox %{version}
Name[hu]=Firefox webböngésző %{version}
Name[it]=Firefox Browser Web %{version}
Name[ja]=Firefox ウェブ・ブラウザ %{version}
Name[ko]=Firefox 웹 브라우저 %{version}
Name[nb]=Firefox Nettleser %{version}
Name[nl]=Firefox webbrowser %{version}
Name[nn]=Firefox Nettlesar %{version}
Name[no]=Firefox Nettleser %{version}
Name[pl]=Przeglądarka WWW Firefox %{version}
Name[pt]=Firefox Navegador Web %{version}
Name[pt_BR]=Navegador Web Firefox %{version}
Name[sk]=Internetový prehliadač Firefox %{version}
Name[sv]=Webbläsaren Firefox %{version}
...
<default-apps>
  <web-browsers>
    <web-browser>
      <name>Firefox 8.0.1</name>
      <executable>/usr/bin/firefox-new</executable>
      <command>/usr/bin/firefox-new %s</command>
      <icon-name>firefox-new</icon-name>
      <run-in-terminal>false</run-in-terminal>
      <netscape-remote>true</netscape-remote>
      <tab-command>/usr/bin/firefox-new %s</tab-command>
      <win-command>/usr/bin/firefox-new --new-window %s</win-command>
    </web-browser>
  </web-browsers>
</default-apps>
EOF
...
%{__mkdir_p} $RPM_BUILD_ROOT/%{_datadir}/gnome-control-center/default-apps
cp %{name}.xml $RPM_BUILD_ROOT/%{_datadir}/gnome-control-center/default-apps
...
%{__mkdir} -p $RPM_BUILD_ROOT/%{mozappdir}/defaults/profile
...
# icons
%{__cp} browser/branding/official/default16.png \
...
%doc mozilla-release/README.txt
...
%changelog
* Tue Jan 31 2012 Thomas Uphill <uphill@ias.edu> - 10.0-1
- update to 10.0

* Wed Jan 11 2012 Thomas Uphill <uphill@ias.edu> - 9.0.1-1
- update to 9.0.1

* Tue Nov 22 2011 Thomas Uphill <uphill@ias.edu> - 8.0.1-1
- update to 8.0.1

* Mon Oct 10 2011 Thomas Uphill <uphill@ias.edu> - 7.0.1-2
- update to 7.0.1

* Wed Sep 28 2011 Martin Stransky <stransky@redhat.com> - 3.6.23-2
- Update to 3.6.23

* Mon Sep 5 2011 Martin Stransky <stransky@redhat.com> - 3.6.22-1
- Update to 3.6.22

* Thu Aug  4 2011 Jan Horak <jhorak@redhat.com> - 3.6.20-2
- Update to 3.6.20
...
* Tue Mar  8 2011 Jan Horak <jhorak@redhat.com> - 3.6.15-2
- Update to 3.6.15
