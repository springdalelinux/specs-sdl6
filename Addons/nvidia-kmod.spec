...
%build
for flavor in %flavors_to_build ; do
    pushd _kmod_build_${flavor}/kernel
...
for flavor in %flavors_to_build ; do
    install -D -m 0755 _kmod_build_${flavor}/kernel/nvidia.ko $RPM_BUILD_ROOT/lib/modules/%kverrel${flavor%default}/extra/nvidia/nvidia.ko
done
...
- convert to weak modules, we prefer it that way
